        ...
        <div class="container-fluid">
          ...
          <div class="container collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav" >
                    ...
                    <li className="nav-item"><Link to="/admin/confirm" className="nav-link">รอการยืนยัน</Link></li>                   <li className="nav-item "><Link to="/user/schedule" className="nav-link">ตารางสอน</Link></li>
            </div>
          </div>
